 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 c8 08 00 00 	movzbl 0x8c8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb be 08 00 00       	mov    $0x8be,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 7c 0b 00 00       	mov    0xb7c,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 7c 0b 00 00       	mov    0xb7c,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 80 0b 00 00       	mov    $0xb80,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 822:	00 00 00 
    if(p->s.size >= nunits){
